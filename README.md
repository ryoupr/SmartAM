...
1. [Releases](https://github.com/ryoupr/SmartAM/releases/latest) から `SmartAM_x.x.x_aarch64.dmg` をダウンロード
2. DMG を開き、SmartAM.app を Applications にドラッグ
3. 初回起動時に「開発元を確認できません」と表示されたら、システム設定 → プライバシーとセキュリティ → 「このまま開く」

アプリ内でアップデート通知が届くので、以降は自動更新できます。
...
```bash
# 1. リポジトリをクローン
git clone https://github.com/ryoupr/SmartAM.git
cd SmartAM
